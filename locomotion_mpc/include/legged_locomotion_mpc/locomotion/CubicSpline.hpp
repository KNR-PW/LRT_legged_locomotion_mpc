 ...
 *      Author: farbod
 * 
 * Modified by Bartłomiej Krajewski (https://github.com/BartlomiejK2) on 06.11.2025 
 */

#ifndef __CUBIC_SPLINE_LEGGED_LOCOMOTION_MPC__
#define __CUBIC_SPLINE_LEGGED_LOCOMOTION_MPC__
